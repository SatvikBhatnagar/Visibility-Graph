# -*- coding: utf-8 -*-
"""
Created on Tue Apr 12 09:15:41 2022
...
ds_btc = pd.read_csv('Q:/Non Linear Dynamics/Visibility Graph/Stock Prices/AAPL 12-01-2016 -- 12-04-2022.csv')
...
plt.ylabel("P(k)")
plt.legend()
plt.title('AAPL: intercepts {} {}'.format(slope, intercept))
