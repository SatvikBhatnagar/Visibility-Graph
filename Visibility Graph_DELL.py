# -*- coding: utf-8 -*-
"""
Created on Tue Apr 12 09:17:25 2022
...
ds_btc = pd.read_csv('Q:/Non Linear Dynamics/Visibility Graph/Stock Prices/DELL 12-01-2017 -- 12-04-2022.csv')
...
plt.ylabel("P(k)")
plt.legend()
plt.title('DELL: intercepts {} {}'.format(slope, intercept))
