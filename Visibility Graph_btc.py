...
ds_btc = pd.read_csv('Q:/Non Linear Dynamics/Visibility Graph/Stock Prices/BTC-USD 1-01-2016 -- 12-04-2022.csv')
...
plt.ylabel("P(k)")
plt.legend()
plt.title('BTC: intercepts {} {}'.format(slope, intercept))
